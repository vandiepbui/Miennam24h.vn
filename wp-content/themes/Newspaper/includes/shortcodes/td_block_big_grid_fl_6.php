 ...
 */
class td_block_big_grid_fl_6 extends td_block {
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                $buffy .= td_util::get_block_error('Big grid full 6', 'Please move this shortcode on a full row in order for it to work.');
            } else {
                ...
                foreach ($posts as $post) {
                    ...
                    if ($post_count < 1) {
                        $td_module_mx18 = new td_module_mx18($post);
                    ...
                    $td_module_mx22 = new td_module_mx22($post);
                    $buffy .= $td_module_mx22->render($post_count);
                ...
                if ($post_count < self::POST_LIMIT) {
                    ...
                    for ($i = $post_count; $i < self::POST_LIMIT; $i++) {
                        ...
                        if ($post_count < 1) {
                            ...
                            $buffy .= $td_module_mx_empty->render($i, 'td_module_mx18');
                        ...
                        $td_module_mx_empty = new td_module_mx_empty();
                        $buffy .= $td_module_mx_empty->render($i, 'td_module_mx22');
