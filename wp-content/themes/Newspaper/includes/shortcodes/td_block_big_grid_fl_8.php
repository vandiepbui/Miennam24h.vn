 ...
 */
class td_block_big_grid_fl_8 extends td_block {
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                $buffy .= td_util::get_block_error('Big grid full 8', 'Please move this shortcode on a full row in order for it to work.');
            } else {
